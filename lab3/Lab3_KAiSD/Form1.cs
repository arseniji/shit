                    ...
                    switch (masivos.SelectedIndex)
                    {
                        case 0:
                            for (int length = 10; length <= 10000; length *= 10)
                                SpeedOfSorting(Genmas.RandomMass, length, Sorts.BubbleSort, Sorts.InsertionSort, Sorts.SelectionSort, Sorts.ShakerSort, Sorts.GnomeSort);
                            break;
                        case 1:
                            for (int length = 10; length <= 10000; length *= 10)
                                SpeedOfSorting(Genmas.RandomSubmass, length, Sorts.BubbleSort, Sorts.InsertionSort, Sorts.SelectionSort, Sorts.ShakerSort, Sorts.GnomeSort);
                            break;
                        case 2:
                            for (int length = 10; length <= 10000; length *= 10)
                                SpeedOfSorting(Genmas.SortedAndSwaped, length, Sorts.BubbleSort, Sorts.InsertionSort, Sorts.SelectionSort, Sorts.ShakerSort, Sorts.GnomeSort);
                            break;
                        case 3:
                            for (int length = 10; length <= 10000; length *= 10)
                                SpeedOfSorting(Genmas.SortedSwapedAndRepeated, length, Sorts.BubbleSort, Sorts.InsertionSort, Sorts.SelectionSort, Sorts.ShakerSort, Sorts.GnomeSort);
                            break;
                    }
                    break;
                case 1:
                    ...
                    switch (masivos.SelectedIndex)
                    {
                        case 0:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.RandomMass, length, Sorts.ShellSort, Sorts.BitonicSort);
                            break;
                        case 1:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.RandomSubmass, length, Sorts.ShellSort, Sorts.BitonicSort);
                            break;
                        case 2:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.SortedAndSwaped, length, Sorts.ShellSort, Sorts.BitonicSort);
                            break;
                        case 3:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.SortedSwapedAndRepeated, length, Sorts.ShellSort, Sorts.BitonicSort);
                            break;
                    }
                    break;
                case 2:
                    ...
                    switch (masivos.SelectedIndex)
                    {
                        case 0:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.RandomMass, length, Sorts.CombSort, Sorts.HeapSort, Sorts.QuickSort, Sorts.MergeSort, Sorts.CountingSort, Sorts.RadixSort);
                            break;
                        case 1:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.RandomSubmass, length, Sorts.CombSort, Sorts.HeapSort, Sorts.QuickSort, Sorts.MergeSort, Sorts.CountingSort, Sorts.RadixSort);
                            break;
                        case 2:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.SortedAndSwaped, length, Sorts.CombSort, Sorts.HeapSort, Sorts.QuickSort, Sorts.MergeSort, Sorts.CountingSort, Sorts.RadixSort);
                            break;
                        case 3:
                            for (int length = 10; length <= 100000; length *= 10)
                                SpeedOfSorting(Genmas.SortedSwapedAndRepeated, length, Sorts.CombSort, Sorts.HeapSort, Sorts.QuickSort, Sorts.MergeSort, Sorts.CountingSort, Sorts.RadixSort);
                            break;
                    }
                    break;
            }
            ...
            for (int i = 0; i < list[0].Count(); i++)
            {
                ...
                switch (chek)
                {
                    ...
                    case 3:
                        ...
                        {
                            case 0:
                                pane.AddCurve("Сортировка расёской", pointList, Color.Green, SymbolType.Default);
                                break;
                            case 1:
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                pane.AddCurve("Сортировка подсчётом", pointList, Color.Black, SymbolType.Default);
                                break;
                            case 4:
                                pane.AddCurve("Сортировка слиянием", pointList, Color.Yellow, SymbolType.Default);
                                break;
                            case 5:
                                pane.AddCurve("Поразрядная сортировка", pointList, Color.Purple, SymbolType.Default);
                                break;
                        }
                        break;
                }
