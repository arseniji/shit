...
namespace sorts
{
    public  class Sorts
    {
        ...
        private static void CountSortByDig(int[] array, int exp, bool isReverse = false)
        {
        ...
        public static int[] RadixSort(int[] array)
        {
            ...
            for (int exp = 1; max / exp > 0; exp *= 10) CountSortByDig(array, exp);
            return array;
        }
        ...
        public static int[] BitonicSort(int[] array) {
            return BitonicSort(array, false);
        }
    }
}
